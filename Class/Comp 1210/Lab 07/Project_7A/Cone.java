...
public class Cone
{
   ...
   *
   * @return counter for number cones. 
   */
   ...
   */
   ...
   /**
   * Checks the obj to see if it a cone.
   * @param obj an object that could be a cone.
   *
   * @return true if it is a cone otherwise returns false. 
   */
  ...
  /**
  * Needed when the equals() method is called.
  *
  * @return 0.
  */
   public int hashCode()
