...
public class ExampleClient {
   ...
   public static void main(String[] args) throws FileNotFoundException {
      ...
      System.out.println("Cag is a word :" + doublets.isWord("cag"));

      System.out.println(doublets.getWordCount());

      //System.out.println(doublets.isWordLadder(Arrays.asList("girl")));
      ...
      System.out.println(doublets.getMinLadder("money", "penny"));
